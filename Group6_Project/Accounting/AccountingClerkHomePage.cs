...
{
    public partial class AccountingClerkHomePage : Form
    {
        ...
        public AccountingClerkHomePage()
        {
            InitializeComponent();
        ...
        private void btnWarehouse_Click(object sender, EventArgs e)
        {
            ...
            Invoice warehouse = new Invoice() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
