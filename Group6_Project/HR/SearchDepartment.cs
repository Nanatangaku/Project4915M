...
{
    public partial class SearchDepartment : Form
    {
        //To get Data from database
        public DataTable GetData(String target)
        {
            String sql = "select * from department where dept_name LIKE '%" + target + "%'";
        ...
        private void SearchDepartment_Load(object sender, EventArgs e)
        {
            showTable("");
        }
    }
