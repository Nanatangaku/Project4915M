...
{
    public partial class PurchaseClerkHomePage : Form
    {
        ...
        {
            panNav.Height = btnPurchaseOrder.Height;
            panNav.Top = btnPurchaseOrder.Top;
            panNav.Left = btnPurchaseOrder.Left;
            btnPurchaseOrder.BackColor = Color.FromArgb(46, 51, 73);

            this.panFormLoad.Controls.Clear();
            SearchPurchaseOrder shop = new SearchPurchaseOrder() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
            shop.FormBorderStyle = FormBorderStyle.None;
            panFormLoad.Controls.Add(shop);
            shop.Show();
        }
        [Category("Event")]
        private void btnPurchaseOrder_Leave(object sender, EventArgs e)
        {
            btnPurchaseOrder.BackColor = Color.FromArgb(51, 51, 76);
        }
    }
}
